...
function Home() {
  ...
  const images = ["1.png", "2.png", "3.png", "4.png"]; // imags for sliding
        ...
        <div className="content">
          ...
          <div className="content-right">
            ...
            <p>FreshFruits offers a wide range of premium quality fruits...
               Fruits are nature's gift to mankind. These are not only delicious 
               and refreshing but are also the chief source of vitamins, minerals 
               and proteins. These constituents are essential for the normal physiological
               well being and help in maintaining healthy state through development of resistance against pathogens.
            </p>
            <a href="/shop" className="shop-button">
              Shop Now
            </a>
